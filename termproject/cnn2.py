...
class ConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=[96, 256, 384], filter_size=[3, 3, 3],
               hidden_dim=[1000, 1000], num_classes=10, weight_scale=1e-3, reg=0.0,
               dtype=np.float32):
    """
  ...
  def loss(self, X, y=None):
    ...
    a2, c2 = conv_relu_pool_forward(a1, theta2, theta2_0, conv_param, pool_param)
    a3, c3 = conv_relu_pool_forward(a2, theta3, theta3_0, conv_param, pool_param)
    ...
    d2, grads['theta3'], grads['theta3_0'] = conv_relu_pool_backward(d3, c3)
    d1, grads['theta2'], grads['theta2_0'] = conv_relu_pool_backward(d2, c2)
